...
result_tmp = document.getElementById("pyresult2")
...
> 음... DOM객체에 접근하는 것이 Local Host에서는 잘 됐는데 deploy 한 후엔 이상하게 Syntax Error이 뜬다. 아직 초기버젼이라 버그인것인지 뭔지 잘 모르겠다. 더 알아봐야 할듯하다.
{:.prompt-warning}
