...
pyscript_result = document.getElementById('pyresult2').getElementsByClassName('rouge-code')[0].getElementsByTagName('pre')[0];
...
#### 1. `pyscript.write('target-id', 'output')`를 이용하는 방법.  

```html
<p id="test1" style="font-size: 1.5rem; color: orange;">Loading...</p>

<py-script>
pyscript.write('test1', 'output1')
</py-script>
```
<p id="test1" style="font-size: 1.5rem; color: orange;">Loading...</p>
