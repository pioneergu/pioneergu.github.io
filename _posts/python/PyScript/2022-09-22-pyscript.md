...
> Output3가 Loading... 뒤에 append되어 출력이 되었었는데 역시 Version 탓인지 append되는 위치가 맨마지막 py-script 결과 뒤에 출력이 된다.  
> Output3는 이 본문의 마지막 py-script 결과인 Output4뒤에 출력이 되는 모습을 확인 할 수 있다.  
